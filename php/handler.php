 ...
 */
$db = new PDO('mysql:host=localhost;dbname=db_network_project;charset=utf8', 'root', '', [
...
function postMessage(){
  global $db;
  // 1. Analyser les paramètres passés en POST (pseudo, content)
  if(!array_key_exists('pseudo',$_SESSION) || !array_key_exists('content', $_POST)){
